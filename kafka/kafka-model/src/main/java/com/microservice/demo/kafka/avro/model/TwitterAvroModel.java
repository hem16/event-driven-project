 ...
 */
package com.microservice.demo.kafka.avro.model;
...
public class TwitterAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public TwitterAvroModel(Long userId, Long id, String text, Long createdAt) {
    this.userId = userId;
    this.id = id;
    this.text = text;
  ...
  public void put(int field$, Object value$) {
    ...
    case 3: createdAt = (Long)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public static com.microservice.demo.kafka.avro.model.TwitterAvroModel.Builder newBuilder() {
    return new com.microservice.demo.kafka.avro.model.TwitterAvroModel.Builder();
  }
   ...
   * @return A new TwitterAvroModel RecordBuilder
   */
  public static com.microservice.demo.kafka.avro.model.TwitterAvroModel.Builder newBuilder(com.microservice.demo.kafka.avro.model.TwitterAvroModel.Builder other) {
    if (other == null) {
      return new com.microservice.demo.kafka.avro.model.TwitterAvroModel.Builder();
    } else {
      return new com.microservice.demo.kafka.avro.model.TwitterAvroModel.Builder(other);
    }
  }
   ...
   * @return A new TwitterAvroModel RecordBuilder
   */
  public static com.microservice.demo.kafka.avro.model.TwitterAvroModel.Builder newBuilder(com.microservice.demo.kafka.avro.model.TwitterAvroModel other) {
    if (other == null) {
      return new com.microservice.demo.kafka.avro.model.TwitterAvroModel.Builder();
    } else {
      return new com.microservice.demo.kafka.avro.model.TwitterAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TwitterAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.microservice.demo.kafka.avro.model.TwitterAvroModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.microservice.demo.kafka.avro.model.TwitterAvroModel other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.userId)) {
        this.userId = data().deepCopy(fields()[0].schema(), other.userId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.microservice.demo.kafka.avro.model.TwitterAvroModel.Builder setUserId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.microservice.demo.kafka.avro.model.TwitterAvroModel.Builder clearUserId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.microservice.demo.kafka.avro.model.TwitterAvroModel.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.microservice.demo.kafka.avro.model.TwitterAvroModel.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.microservice.demo.kafka.avro.model.TwitterAvroModel.Builder setText(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.microservice.demo.kafka.avro.model.TwitterAvroModel.Builder clearText() {
      text = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.microservice.demo.kafka.avro.model.TwitterAvroModel.Builder setCreatedAt(Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.microservice.demo.kafka.avro.model.TwitterAvroModel.Builder clearCreatedAt() {
      createdAt = null;
